// Package issue implements a placeholder Issues screen. Full functionality is
// tracked under Epic 3; this is a navigable shell only.
package issue
...
// Model is the placeholder Issues screen.
type Model struct {
	width  int
	height int
}
...
// New returns a placeholder Issues screen sized to the current window.
